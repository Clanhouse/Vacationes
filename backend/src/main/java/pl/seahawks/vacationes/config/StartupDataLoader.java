...
public class StartupDataLoader {
    ...
    public void loadData(ContextRefreshedEvent event){
        ...
        //example location
        Location location1 = Location.builder().country("Poland").city("Warsaw").airportName("Chopin Airport").district("Wlochy").holidays(new ArrayList<>())
                .flights(new ArrayList<>()).build();
        Location location2 = Location.builder().country("Spain").city("Madrid").airportName("Adolfo Suárez Madrid-Barajas Airport.").holidays(new ArrayList<>())
