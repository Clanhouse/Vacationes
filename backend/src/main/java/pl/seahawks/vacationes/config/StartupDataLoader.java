...
import pl.seahawks.vacationes.domain.holiday.OfferPackage;
import pl.seahawks.vacationes.domain.holiday.OfferType;
...
import pl.seahawks.vacationes.domain.user.role.RoleRepository;
